...
\author{ Мухачев Петр \\Козлов Дмитрий \\Милованов Артем }
\date{\today}
...
\begin{frame}{Доля дефектов}
\centering
\includegraphics[width=1\textwidth]{./1.png}
\end{frame}

\begin{frame}{Тренд месячной доли дефектов}
\centering
\includegraphics[width=1\textwidth]{./4.png}
\end{frame}

\begin{frame}{Сравнение производства с дефектами}
\centering
\includegraphics[width=0.8\textwidth]{./2.png}
\end{frame}

\begin{frame}{Дополнительные метрики}
\centering
...
\begin{frame}{Выводы и рекомендация}
    \begin{enumerate}
        ...
        \(0.02477 < 0.08484\)
        \item Тренд улучшения у \texttt{harpy.co} быстрее
